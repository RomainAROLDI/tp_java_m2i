...
INSERT INTO utilisateur (id, email, password, role_id)
VALUES (1, 'a@a', '$2a$10$tod199z/WlRRqwJ5NqWiNuMTMW3GgO.rDWQgRfmu9ZkzaAxzgmdtW', 1),
...
INSERT INTO produit (nom, prix, vendeur_id)
VALUES ('filament PLA', 25.99, NULL),
       ('buse 2mm', 50.20, 2);
